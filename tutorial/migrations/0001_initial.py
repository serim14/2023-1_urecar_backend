    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("plotname", models.CharField(blank=True, max_length=45, null=True)),
                ("location", models.CharField(max_length=45)),
                ("fee", models.IntegerField(blank=True, null=True)),
            ],
            options={"db_table": "parking_lot", "managed": False,},
        ),
        migrations.CreateModel(
            name="User",
            fields=[
                ("userid", models.IntegerField(primary_key=True, serialize=False)),
                ("carnum", models.CharField(blank=True, max_length=45, null=True)),
